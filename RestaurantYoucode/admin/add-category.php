...
<div class="main-content">
    <div class="wrapper">
        <h1 class="hadmin">Add Category</h1>
        ...
        if(isset($_POST['submit']))
        {
            ...
            {
                // todo to upload image we need image name and source path and distination path
                ...
                $distination_path = "../img/upload-img/".$image_name;
                ...
                if($upload == false)
                {
                    ...
                    // bcz i dont want to data to be inserted i have to stop the proces by die function
                    die();
                }
